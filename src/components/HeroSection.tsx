...
const HeroSection = () => {
    <section className="relative overflow-hidden bg-background py-20 border-b border-border">
      ...
      <div className="container relative mx-auto px-4 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tight animate-fade-in text-foreground">
          <span className="vault-text-gradient">VAULT</span>
        </h1>
        
        <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto mb-8 animate-fade-in font-medium leading-relaxed">
          The difference between a camera roll<br/>and a career.
        </p>

        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 text-muted-foreground animate-fade-in mt-12">
          <div className="text-center">
            <Lock className="h-6 w-6 text-vault-gold mx-auto mb-2" />
            <div className="font-black text-sm uppercase tracking-wide text-foreground mb-1">Identify</div>
          ...
          <div className="text-center">
            ...
            <div className="font-black text-sm uppercase tracking-wide text-foreground mb-1">Protect</div>
          ...
          <div className="text-center">
            ...
            <div className="font-black text-sm uppercase tracking-wide text-foreground mb-1">Monetize</div>
